 ...
 */
package za.co.pas.tool.multidownloader.logging;
...
public class MyLogFormatter extends Formatter {
    public static final String NO_PRINTLIN = "[#NP#]";

    @Override
    public String format(LogRecord record) {
        
        StringBuilder sb = new StringBuilder();
        if(record.getMessage().startsWith(NO_PRINTLIN)) {
            sb.append(record.getMessage().substring(NO_PRINTLIN.length()));
        } else {
